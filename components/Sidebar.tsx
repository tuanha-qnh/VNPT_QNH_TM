...
import { LayoutDashboard, Users, CheckSquare, BarChart2, Settings, Menu, PieChart, StickyNote, BarChartBig, Smartphone } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeModule, setActiveModule, isOpen, toggleSidebar, currentUser }) => {
  ...
  const menuItems = [
    ...
    { type: 'divider' },
    { id: 'mobile-ops', label: 'Quản trị CTHĐ Di động', icon: <Smartphone size={20} /> },
